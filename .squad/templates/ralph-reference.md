# Ralph Reference — Work Monitor

> On-demand reference for Squad Coordinator. Read when Ralph is activated or running.
...
After the coordinator's "Immediately assess: Does anything trigger follow-up work?" step, if Ralph is active, the coordinator MUST automatically run Ralph's work-check cycle. **Do NOT return control to the user.** This creates a continuous pipeline:
